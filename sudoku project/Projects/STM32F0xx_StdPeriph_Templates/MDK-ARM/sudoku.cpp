...
unsigned char TAB_A[BOARD_SIZE];
unsigned char TAB_B[BOARD_SIZE];
int TAB_C[BOARD_SIZE];
unsigned char TAB_D[POSSIBILITY_SIZE];
unsigned char TAB_E[BOARD_SIZE]; 
unsigned char TAB_F[NUM_POSS]; 
...
SudokuBoard::SudokuBoard(){
    /*puzzle = new unsigned char[BOARD_SIZE];
		//puzzle = (unsigned char *)malloc(BOARD_SIZE);
    solution = new unsigned char[BOARD_SIZE];
		//solution = (unsigned char *)malloc(BOARD_SIZE);
    ...
    randomPossibilityArray = new unsigned char[NUM_POSS];*/
		...
		/*puzzle =  (unsigned char *)malloc(sizeof(unsigned char)*BOARD_SIZE);
    solution = (unsigned char*)malloc(sizeof(unsigned char)*BOARD_SIZE);
    solutionRound = (int*)malloc(sizeof(int)*BOARD_SIZE);
    possibilities = (unsigned char*)malloc(sizeof(unsigned char)*POSSIBILITY_SIZE);
    recordHistory = true;
    printStyle = READABLE;
    randomBoardArray = (unsigned char*)malloc(sizeof(unsigned char)*BOARD_SIZE);
    randomPossibilityArray = (unsigned char*)malloc(sizeof(unsigned char)*NUM_POSS);*/
    ...
    recordHistory = true;
    printStyle = READABLE;
    randomBoardArray = TAB_E;
    randomPossibilityArray = TAB_F;
...
void SudokuBoard::rollbackRound(int round){
    ...
    /*
    kasujê dane o operacjach z tej rundy
    */
